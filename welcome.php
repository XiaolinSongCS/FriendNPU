...
<html>
    ...
    <body>
        ...
        <div class="upLink">
            <a href ="signUp.php" class="signUpLink" ><b>Sign Up </b></a>
        </div>

        <div  class="InLink">
            <a href ="signIn.php" class="signInLink"><b>Sign In</b></a>
        </div>
        ...
        <div class="welcome">
            ...
            <img id ="imageWelcome" src="./pictures/welcome.jpg" alt="welcome" width="450" height="550" onload="changeImg()">
        
            <div class="center">
                <a href = "signUp.php" class="button">Join Us Now </a>
            </div>
